...
<tbody>
    ...
    $sql="SELECT name,flat_no,start_date,end_date from resident join gym using(flat_no)";
    ...
    <div class="reset">
    <a href="reset.php?rn=<?php echo 3;?>">Reset Revenue</a>
   </div> 
</body>
</html>
...
<div class="data">
   ...
   $sql1="select count(*) from parking";
...
<tbody>
    ...
    $sql="SELECT name,flat_no,start_date,end_date from resident join parking using(flat_no)";
    ...
    <div class="reset">
    <a href="reset.php?rn=<?php echo 4;?>">Reset Revenue</a>
   </div> 
</body>
</html>
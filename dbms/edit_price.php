...
if($_SERVER['REQUEST_METHOD']=='GET'){
        $department=$_GET["rn"];
        $sql="SELECT * FROM facilities WHERE department='$department'";
...
$price=$_POST['price'];
$sql="UPDATE `facilities` SET  `duration`='$duration', `price`=$price WHERE department='$department'";
...
color:white;
    ...
    <div class="container">
        <h2>FlatEasy</h2>
        <br>
        <p>Update details of the Facilities</p>
        <?php
        if ($insert==true){
        ...
        <input type="hidden" id="department" name="department" value="<?php echo $department;?>">
            ...
            <input type="text" id="duration" name="duration"  value="<?php echo $duration;?>" placeholder="Duration">
            <input type="number" id="price" name="price" value="<?php echo $price;?>" placeholder="Price">
            <button class="btn">Submit</button>
        </form>
    </div>
    <p class="back"><a href="view_facility.php">view</a></p>
</body>
</html>
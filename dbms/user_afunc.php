...
if($_SERVER['REQUEST_METHOD']=='GET'){
       ...
       $sql="SELECT duration FROM `facilities` WHERE department='function hall';";
       $result=$con->query($sql);
...
<h1>Flat<span>Easy</span><strong><?php echo ($row1['name']);?></strong></h1>
    <br>
    <div class="heading">
       YOU HAVE NO ACCESS TO FUNCTION HALL    
       <br>   
         CLICK ON THE BELOW LINK TO HAVE ACCESS
         <p class="price">PRICE   -  <?php echo $row['price'];?></p>
         <p class="price">DURATION   -  <?php echo $row2['duration'];?></p>
        <a href="func_acc.php?rn=<?php echo $flat_no;?>" class="btn">FUNCTION HALL ACCESS</a>
     </div>
</body>
</html>
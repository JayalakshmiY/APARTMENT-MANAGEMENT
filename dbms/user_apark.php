...
if($_SERVER['REQUEST_METHOD']=='GET'){
       $flat_no=$_GET["rn"];
       $sql="SELECT price FROM `facilities` WHERE department='parking';";
       ...
       $sql="SELECT duration FROM `facilities` WHERE department='parking';";
       $result=$con->query($sql);
...
<body>
    ...
    <br>
    <div class="heading">
       YOU HAVE NO ACCESS TO PARKING       
     CLICK ON THE BELOW LINK TO HAVE ACCESS
     <p class="price">PRICE   -  <?php echo $row['price'];?></p>
     <p class="price">DURATION   -  <?php echo $row2['duration'];?></p>
        <a href="park_acc.php?rn=<?php echo $flat_no;?>" class="btn">PARKING ACCESS</a>
     </div>
</body>
</html>
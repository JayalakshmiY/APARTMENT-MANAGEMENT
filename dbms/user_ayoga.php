...
if($_SERVER['REQUEST_METHOD']=='GET'){
       $flat_no=$_GET["rn"];
       $sql="SELECT price FROM `facilities` WHERE department='yoga';";
       ...
       $sql="SELECT duration FROM `facilities` WHERE department='yoga';";
       $result=$con->query($sql);
...
<body>
     <h1>Flat<span>Easy</span><strong><?php echo ($row1['name']);?></strong></h1>
        <br>
    <div class="heading">
       YOU HAVE NO ACCESS TO YOGA     <br>  
     CLICK ON THE BELOW LINK TO HAVE ACCESS
     <p class="price">PRICE   -  <?php echo $row['price'];?></p>
     <p class="price">DURATION   -  <?php echo $row2['duration'];?></p>
        <a href="yoga_acc.php?rn=<?php echo $flat_no;?>" class="btn">YOGA CLASS ACCESS</a>
     </div>
</body>
</html>